...
class Database
{
    ...
    private $db_name = 'databasename';  // Database
    /*
     * End edit
     */
    ...
    {	 
		...
		$this->db_host = $GLOBALS['config']['db']['host'];
		$this->db_user = $GLOBALS['config']['db']['username'];
		$this->db_pass = $GLOBALS['config']['db']['password'];
		$this->db_name = $GLOBALS['config']['db']['dbname'];
